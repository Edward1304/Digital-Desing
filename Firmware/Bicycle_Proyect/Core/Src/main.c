...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, R_SPEED_LED_Pin|GPIO_PIN_12|FLASH_CS_Pin, GPIO_PIN_RESET);
  ...
  HAL_GPIO_Init(SPEED_SENSOR_DIGITAL_PIN_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : R_SPEED_LED_Pin PA12 FLASH_CS_Pin */
  GPIO_InitStruct.Pin = R_SPEED_LED_Pin|GPIO_PIN_12|FLASH_CS_Pin;
  ...
  /*Configure GPIO pins : PB_C_Pin PB_B_Pin PB_A_Pin */
  GPIO_InitStruct.Pin = PB_C_Pin|PB_B_Pin|PB_A_Pin;
